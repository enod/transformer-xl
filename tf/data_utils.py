...
from vocabulary_piece import Vocab
...
class Corpus(object):
    def __init__(self, path, dataset, *args, **kwargs):
        ...
        # elif self.dataset == "wt103" or "mn-dataset":
        #     self.vocab.count_file(os.path.join(path, "train.txt"))
        ...
        if self.dataset in ["ptb", "wt2", "wt103", "mn-dataset"]:
        ...
        if self.dataset == "wt103" or "mn-dataset":
    ...
    def convert_to_tfrecords(self, split, save_dir, bsz, tgt_len,
        ...
        if self.dataset in ["ptb", "wt2", "wt103", "enwik8", "text8", "mn-dataset"]:
...
def get_lm_corpus(data_dir, dataset):
    ...
    if exists(fn):
        ...
        elif dataset == "mn-dataset":
            kwargs["model_path"] = '../data'
            kwargs["vocab_file"] = 'mn_cased.vocab'
        elif dataset == "ptb":
            kwargs["special"] = ["<eos>"]
...
if __name__ == "__main__":
    ...
    flags.DEFINE_enum("dataset", "wt103",
                      ["ptb", "wt2", "wt103", "lm1b", "enwik8", "text8", "mn-dataset"],
                      help="Dataset name.")
