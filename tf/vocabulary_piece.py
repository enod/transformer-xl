# Modified version of https://github.com/kimiyoung/transformer-xl/blob/master/tf/vocabulary.py
# Uses mongolian-bert trained sentencepiece model and vocabulary for tokenization.
